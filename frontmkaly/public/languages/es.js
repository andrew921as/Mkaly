...
export default{
	...
	AboutUs:{
		...
		Description2:"Dando una sensacion de confianza con nustros mas de 30 años de experiencia brindando un excelente ServiceWorkerRegistration, siempre respetuose y tratando de resolver cada problema en tiempo record.",
	},							
	ContactUs:{
		Title: "CONTACTANOS",
	...
	NewProject:{
		...
		Description3: "Nuestras fuentes de energía son renovables, mostrando nuestra preocupación por el medio ambiente. Al mismo tiempo ofrecemos puestos de trabajo a las comunidades cercanas para que así hagan parte del cambio.",
