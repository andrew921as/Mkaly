export default{
	...
	AboutUs:{
		...
		Description2:"Providing a felling of trust whit our 30 years of experience bringing an excellent service, always been respectful and trying to solve any problem in record time",
	},
	ContactUs:{
		Title: "CONTACT US",
	...
	NewProject:{
		...
		Description3: "Our energy sources are renewable, so we care about the environment. At the same time we offer work to the surrounding communities so that they can also be part of the change.",
