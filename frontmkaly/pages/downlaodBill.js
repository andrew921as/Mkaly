...
import { Box, Typography, Button, Stack, TextField, useTheme, useMediaQuery } from '@mui/material'
        ...
        <div className='flex justify-center items-center'>
            ...
            {isMatch ? '' : <div className='flex justify-center items-center'>
                ...
                <Stack
                    ...
                    alignItems="center"
                    spacing={2}>
                    <Typography sx={{ fontSize: { md: '30px', xs: '18px' }, color: '#00408F', fontWeight: 'bold' }}> {t.consultBill.Title2} </Typography>
                    <Box>
